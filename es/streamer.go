...
func (s *streamer) Start(ctx context.Context, opts InitializeOptions, callback EventCallback) error {
	...
	mapper := map[string]EventDataFunc{}
...
func (s *streamer) Publish(ctx context.Context, evt ...*Event) error {
...
func NewStreamer(cli PubClient) (Streamer, error) {
	return &streamer{
		cli: cli,
	}, nil
}
